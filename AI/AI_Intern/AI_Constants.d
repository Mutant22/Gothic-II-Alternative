...
var int timer125ms;
var int timer1s;
var int timer30sdrunken;
var int flagplayerdrunken;
var int counterbooze;
var int counterwine;
var int counterbeer;
var int counterrum;
var int countergrog;
...
var int tp_taverne;
var int tp_farm;
var int tp_monastery;
var int tp_xardas;
var int tp_teleportpassnw;
var int tp_teleportpassow;
var int tp_oldcamp;
var int multiteleportstart;
var int meatcookstart;
var int ignothstart;
var int ignothstartii;
var int meltingironstart;
var int knows_meltingler;
var int knows_bowscrollsi;
var int knows_bowscrollsii;
var int knows_bowscrollsiii;
var int knows_arrowbolt;
var int knows_newsmith;
var int knows_newsmith2;
...
const int ID_DRACONIAN_SHAMAN = 69;
const int ID_STORMGOLEM = 70;
const int ID_UNDEAD_SEEKER = 71;
const int ID_WOODGOLEM = 72;
const int ID_RABBIT = 73;
...
const int AIV_ShieldTactic = 89;
const int AIV_ShieldEquipped = 90;
...
const int MOBSI_COOK = 8;
const int MOBSI_COOK2 = 9;
const int MOBSI_SCHUERFEN = 10;
const int MOBSI_TRINKFASS = 11;
const int MOBSI_SKINCREATE = 12;
const int MOBSI_FISHING = 13;
const int MOBSI_MULTITELEPORT = 14;
const int MOBSI_BOWMAKER = 15;
const int MOBSI_WOODMAKER = 16;
const int MOBSI_FORGEMAKER = 17;
