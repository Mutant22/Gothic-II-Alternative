...
instance DIA_WULFGAR_TEACH3(C_Info)
{
	npc = MIL_312_Wulfgar;
	nr = 7;
	condition = dia_wulfgar_teach3_condition;
	information = dia_wulfgar_teach3_info;
	permanent = TRUE;
...
func void dia_wulfgar_teach3_info()
{
...
instance DIA_WULFGAR_TEACH4(C_Info)
{
	npc = MIL_312_Wulfgar;
	nr = 7;
	condition = dia_wulfgar_teach4_condition;
	information = dia_wulfgar_teach4_info;
	permanent = TRUE;
...
func void dia_wulfgar_teach4_info()
{
	AI_Output(other,self,"DIA_wulfgar_Teach_15_00");	//Začněme s výcvikem.
	if((other.guild == GIL_SLD) || (other.guild == GIL_DJG))
	{
